...
缓存后，严格候选增至4,760条，对应4,279个公司指标任务；矩阵仍缺18,439项，关键缺口5,161项。
自动策略预览确认4,210组，69组进入人工签名队列。

港股最后12家缺口已扩展扫描至2020—2026年，并按财年结束年度归一化。10家补齐2025年报；
`00702.HK`与`01101.HK`最新正式年报停在2023，继续作为真实缺失。目标年度统一索引现为794份，
612/614家有年报、163家有独立ESG报告。强制`--report-year 2025`后候选为4,756条/4,275组，
自动确认预览4,206组，69组需人工签名。
