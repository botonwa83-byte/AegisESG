...
不作为应收账款。当前生成285条候选，覆盖10项治理、5项关键环境和3项关键社会指标；`00600.HK`
附录PDF列顺序及`00196.HK`研发投入/费用口径产生两组冲突候选，必须人工复核；其余观测也保持
...
当前矩阵为92×37=3,404项：275项已有待审候选，3,129项仍需扩展抽取规则，其中863项为关键
指标缺口。任务按“缺失关键指标、已有关键候选、缺失普通指标、已有普通候选”排序；矩阵
`applicable=false`，不会把候选误作确认数据。
