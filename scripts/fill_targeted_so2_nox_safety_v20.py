#!/usr/bin/env python3
"""Targeted research fill for SO2/NOx/safety recall (v20 → v43).

Clue-filtered re-extract for companies missing key intensities/rates, plus
forced correction for known bad NOx intensity year-column picks. Research-only.
...
BASE_OBS = ROOT / "output/research/2025/full_auto_observations_v43_enriched.csv"
...
OUT_OBS = ROOT / "output/research/2025/full_auto_observations_v43_enriched.csv"
AUDIT_JSON = ROOT / "output/audit/authority_gap_fill_v20_2025.json"
AUDIT_CSV = ROOT / "output/audit/authority_gap_fill_v20_2025.csv"
TAG = "[research-only:authority-gap-fill-v20;not-formal]"
...
def main() -> None:
    ...
    summary = {
        "policy_version": "authority-gap-fill-v20-targeted-so2-nox-safety",
        ...
        "notice": "安全投入金额派生/废气NOx/两年强度末列定点召回；不把硫氧化物等同SO2；非正式。",
    }
