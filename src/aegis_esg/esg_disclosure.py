...
QUALITATIVE_ALIASES = {
    ...
    "X_E_ENERGY_MANAGEMENT": ("energy management", "energy conservation", "energy efficiency", "能源管理", "节能", "能源效率"),
    ...
    "X_E_CLIMATE_RISK": ("climate risk", "physical risk", "transition risk", "气候风险", "实体风险", "转型风险"),
    "X_E_CLIMATE_ACTION": ("climate change", "气候变化"),
    "X_E_BIODIVERSITY": ("biodiversity", "biodiversity conservation", "ecological protection", "ecosystem protection", "生物多样性", "生态保护"),
    ...
    "X_G_TAX": ("tax compliance", "tax governance", "taxation", "纳税", "税务治理", "依法纳税"),
    "X_G_INTEGRITY": ("business ethics", "integrity and compliance", "code of conduct", "compliance management", "诚信合规", "道德准则", "合规管理"),
}
