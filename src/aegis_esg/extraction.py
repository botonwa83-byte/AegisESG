...
RULES = (
    ...
    _rule("Q_E_NOX_INTENSITY", r"氮氧化物(?:\s*[（(]\s*NO[xXₓ]\s*[）)])?(?:排放)?强度|(?:NOx|NO[xₓ])(?:排放)?强度",
          r"(?:克|g|千克|kg|吨|t)[/／](?:万|百万)?元(?:营收|营业收入|收入)?",
          {"克/万元": 1, "g/万元": 1, "千克/万元": 1000, "kg/万元": 1000, "吨/万元": 1000000, "克/百万元": 0.01, "吨/百万元": 10000}, .83),
    _rule("Q_E_SO2_INTENSITY", r"二氧化硫(?:\s*[（(]\s*SO[₂2]\s*[）)])?(?:排放)?强度|(?:SO2|SO₂)(?:排放)?强度",
          r"(?:克|g|千克|kg|吨|t)[/／](?:万|百万)?元(?:营收|营业收入|收入)?",
          {"克/万元": 1, "g/万元": 1, "千克/万元": 1000, "kg/万元": 1000, "吨/万元": 1000000, "克/百万元": 0.01, "吨/百万元": 10000}, .83),
    ...
    _rule("Q_S_SAFETY_INVEST_RATE", r"(?:安全生产|生产安全)(?:投入|费用|支出)(?:占比|比例|占营业收入比例)",
          r"[%％]", {"%": 1, "％": 1}, .85),
    _rule("Q_S_RD_RATE", r"(?:研发|R&D|RD|研究开发|研究与开发)(?:费用|投入|支出|经费)(?:占比|比例|强度|占营业收入)?",
          r"[%％]", {"%": 1, "％": 1}, .85),
    _rule("Q_G_DEBT_ASSET_RATE", r"资产负债率|负债资产比率",
          r"[%％]", {"%": 1, "％": 1}, .90),
    # Day 1 新增规则: 高频指标
    _rule("Q_S_PAY_PER_EMPLOYEE", r"(?:员工|职工|雇员)(?:平均)?(?:薪酬|工资|报酬|年薪|薪资)", r"(?:万|千)?元(?:[/／]人|人均)?", {"元": 1, "千元": 1000, "万元": 10000, "元/人": 1, "千元/人": 1000, "万元/人": 10000}, .88),
    _rule("Q_S_ENV_INVEST_RATE", r"环(?:境)?(?:保护|保|境保护)(?:投入|支出|投资|费用|成本)(?:占比|比例|占营业收入)?", r"%|％", {"%": 1, "％": 1}, .90),
    _rule("Q_E_PM_INTENSITY", r"(?:颗粒物|PM|粉尘|烟尘|烟粉尘|大气颗粒物)(?:排放)?强度", r"(?:千克|kg|吨|t|克|g)[/／](?:万|百万)?元", {"千克/万元": 1, "kg/万元": 1, "吨/万元": 1000, "t/万元": 1000, "克/万元": 0.001, "g/万元": 0.001, "吨/百万元": 10}, .85),
    _rule("Q_E_HAZ_WASTE_INTENSITY", r"危险(?:固体)?废物(?:排放|产生)?强度", r"(?:千克|kg|吨|t|克|g)[/／](?:万|百万)?元", {"千克/万元": 1, "kg/万元": 1, "吨/万元": 1000, "t/万元": 1000, "克/万元": 0.001, "g/万元": 0.001, "吨/百万元": 10}, .85),
    _rule("Q_E_WASTEWATER_INTENSITY", r"(?:废|污)水(?:排放|产生)?强度", r"(?:千克|kg|吨|t|立方米|m³|立方|方)[/／](?:万|百万)?元", {"千克/万元": 1, "kg/万元": 1, "吨/万元": 1000, "t/万元": 1000, "立方米/万元": 1000, "m³/万元": 1000, "立方/万元": 1000, "方/万元": 1000, "吨/百万元": 10, "立方米/百万元": 10}, .85),
    _rule("Q_S_FEMALE_EMPLOYEE_RATE", r"女性(?:员工|职工|雇员)(?:占比|比例|比率)", r"[%％]", {"%": 1, "％": 1}, .88),
    _rule("Q_S_BENEFIT_PER_EMPLOYEE", r"(?:员工|职工|雇员)(?:福利|社保|公积金|社会保障)(?:费用|支出|成本)", r"(?:万|千)?元(?:[/／]人)?", {"元": 1, "千元": 1000, "万元": 10000, "元/人": 1, "千元/人": 1000, "万元/人": 10000}, .86),
    _rule("Q_S_EDU_PER_EMPLOYEE", r"(?:工会|职工教育|员工教育|教育培训)(?:经费|费用|支出|投入)", r"(?:万|千)?元(?:[/／]人)?", {"元": 1, "千元": 1000, "万元": 10000, "元/人": 1, "千元/人": 1000, "万元/人": 10000}, .86),
    _rule("Q_E_GHG_REDUCTION_RATE", r"(?:温室气体|碳|GHG|CO2|CO₂)(?:减排|减少|降低)(?:率|比例|幅度)", r"[%％]", {"%": 1, "％": 1}, .87),
    _rule("Q_E_CLEAN_ENERGY_INTENSITY", r"(?:清洁|可再生|绿色|新)能源(?:使用|消费|消耗|利用)?(?:占比|比例|强度|比率)", r"[%％]", {"%": 1, "％": 1}, .86),
    # Day 1 晚上：补充剩余7个规则
    _rule("Q_G_OPERATING_PROFIT_GROWTH", r"营业利润(?:增长|增幅|增速|增长率)(?:率)?", r"[+-]?[\d,]+(?:\.\d+)?[%％]", {"%": 1.0, "％": 1.0}, .88),
    _rule("Q_S_FEMALE_MANAGER_RATE", r"女性(?:管理|高管|领导|管理人员|中高层)(?:人员|者|干部)?(?:占比|比例|比率)", r"[\d,]+(?:\.\d+)?[%％]", {"%": 1.0, "％": 1.0}, .87),
    _rule("Q_S_EMPLOYEE_TRAINING_HOUR", r"(?:员工|职工|人均)(?:人均)?培训(?:时长|时间|学时|课时)", r"(?:小时|课时|学时|时)", {"小时": 1.0, "课时": 1.0, "学时": 1.0, "时": 1.0}, .86),
    _rule("Q_S_SOCIAL_INSURANCE_RATE", r"社会?保险(?:缴纳|覆盖|参保)?(?:率|比例|比率)", r"[%％]", {"%": 1, "％": 1}, .87),
    _rule("Q_S_ACCIDENT_RATE", r"(?:安全)?事故(?:发生)?(?:率|次数)", r"(?:次|起)/", {"次": 1.0, "起": 1.0}, .85),
    _rule("Q_E_WATER_CONSUMPTION", r"水资源?(?:消耗|用水|取水|消费)(?:总)?量", r"(?:万|千)?(?:吨|立方米|m³|立方|方)", {"吨": 1.0, "万吨": 10000, "千吨": 1000, "立方米": 1.0, "万立方米": 10000, "m³": 1.0, "立方": 1.0, "万立方": 10000, "方": 1.0}, .86),
    # 最后冲刺：补充财务指标
    _rule("Q_G_CASH_CURRENT_LIABILITY", r"(?:经营活动)?现金流量?(?:净额)?[^\d]{0,30}流动负债", r"[\d,]+(?:\.\d+)?", {"": 1.0}, .88),
    # 最后补充：剩余高价值指标
    _rule("Q_E_ALTERNATIVE_WATER_RATE", r"(?:再生|循环|中水|替代|回用)水(?:源)?(?:使用|利用|回用)?(?:占比|比例|率|比率)", r"[%％]", {"%": 1, "％": 1}, .85),
    _rule("Q_E_ENERGY_CONSUMPTION", r"(?:综合|总)?能源(?:消耗|消费|耗用)(?:总)?量", r"(?:万|千)?(?:吨|千克|kg)标准煤", {"吨标准煤": 1.0, "万吨标准煤": 10000, "千吨标准煤": 1000, "千克标准煤": 0.001, "kg标准煤": 0.001}, .86),
    _rule("Q_S_DONATION_RATE", r"(?:公益|社会|对外)?捐赠(?:支出|金额)?(?:占比|比例|占营业收入|比率)", r"[%％]", {"%": 1, "％": 1}, .87),
    _rule("Q_G_INDEPENDENT_DIRECTOR_RATE", r"独立董事(?:占比|比例|人数|比率)", r"[%％]|人", {"%": 1, "％": 1, "人": 1}, .88),
    _rule("Q_G_BOARD_MEETING_FREQ", r"董事会(?:会议)?(?:召开)?次数", r"次", {"次": 1.0}, .89),
    _rule("Q_G_AUDIT_FEE", r"审计费用", r"(?:万|千)?元", {"元": 1.0, "千元": 1000, "万元": 10000}, .87),
    # 新增总量类指标
    _rule("Q_E_GHG_EMISSION", r"(?:温室气体|碳|GHG|CO2|CO₂|二氧化碳)(?:排放)?(?:总)?量", r"(?:万|千)?吨", {"吨": 1.0, "万吨": 10000, "千吨": 1000}, .85),
    _rule("Q_E_SO2_EMISSION", r"(?:二氧化硫|SO2|SO₂)(?:排放)?(?:总)?量", r"(?:万|千)?(?:吨|千克|kg)", {"吨": 1.0, "万吨": 10000, "千吨": 1000, "千克": 0.001, "kg": 0.001}, .85),
    _rule("Q_E_NOX_EMISSION", r"(?:氮氧化物|NOx|NOₓ)(?:排放)?(?:总)?量", r"(?:万|千)?(?:吨|千克|kg)", {"吨": 1.0, "万吨": 10000, "千吨": 1000, "千克": 0.001, "kg": 0.001}, .85),
    _rule("Q_E_PM_EMISSION", r"(?:颗粒物|PM|粉尘|烟尘)(?:排放)?(?:总)?量", r"(?:万|千)?(?:吨|千克|kg)", {"吨": 1.0, "万吨": 10000, "千吨": 1000, "千克": 0.001, "kg": 0.001}, .84),
    _rule("Q_E_WASTEWATER_DISCHARGE", r"(?:废|污)水(?:排放)?(?:总)?量", r"(?:万|千)?(?:吨|立方米|m³)", {"吨": 1.0, "万吨": 10000, "千吨": 1000, "立方米": 1.0, "万立方米": 10000, "m³": 1.0}, .85),
    _rule("Q_E_SOLID_WASTE_GENERATION", r"(?:一般)?固(?:体)?废(?:物)?(?:产生|排放)?(?:总)?量", r"(?:万|千)?吨", {"吨": 1.0, "万吨": 10000, "千吨": 1000}, .84),
    _rule("Q_E_HAZ_WASTE_GENERATION", r"危险废物(?:产生|排放)?(?:总)?量", r"(?:万|千)?吨", {"吨": 1.0, "万吨": 10000, "千吨": 1000}, .84),
    # 新增社会指标
    _rule("Q_S_LABOR_CONTRACT_RATE", r"劳动合同(?:签订)?(?:率|比例)", r"[%％]", {"%": 1, "％": 1}, .86),
    _rule("Q_S_EMPLOYEE_TURNOVER_RATE", r"(?:员工|职工)(?:流失|离职)率", r"[%％]", {"%": 1, "％": 1}, .85),
    # 新增治理指标
    _rule("Q_G_BOARD_SIZE", r"董事会(?:成员|人数|规模)", r"人", {"人": 1.0}, .88),
    _rule("Q_G_SUPERVISOR_MEETING_FREQ", r"监事会(?:会议)?(?:召开)?次数", r"次", {"次": 1.0}, .88),
    _rule("Q_G_SHAREHOLDER_MEETING_FREQ", r"股东(?:大会)?(?:会议)?(?:召开)?次数", r"次", {"次": 1.0}, .89),
    _rule("Q_G_AUDIT_COMMITTEE_MEETING_FREQ", r"审计委员会(?:会议)?(?:召开)?次数", r"次", {"次": 1.0}, .87),
)
...
DIRECT_RULES = (
    ...
    DirectRule(
        "Q_E_GHG_INTENSITY",
        re.compile(
            r"(?:温室气体|GHG|碳|CO2|CO₂|二氧化碳)(?:排放|减排)?强度\s+" +
            r"(?:[^\n]*?)" +  # 允许单位和其他内容
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +  # 跳过前面的数值
            NUMBER + r"\s*$",  # 匹配行尾数值
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_WATER_INTENSITY",
        re.compile(
            r"(?:水资源?|用水|耗水|新鲜水)(?:使用|消耗|消费|耗用)?强度\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_NOX_INTENSITY",
        re.compile(
            r"(?:氮氧化物|NOx|NOₓ|氮化物|氮氧化合物)(?:排放)?强度\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        ...
        re.compile(
            r"(?:一般)?(?:固(?:体)?废(?:物)?|固废|固体废弃物|一般废物|工业固废)(?:产生|排放|生产)?强度\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_GHG_INTENSITY",
        re.compile(
            r"(?:每百万|单位)(?:元)?(?:营收|营业收入|收入)(?:的)?(?:温室气体|碳|GHG|CO2|CO₂)(?:排放)?(?:量|强度)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_ENERGY_INTENSITY",
        re.compile(
            r"(?:每百万|单位)(?:元)?(?:营收|营业收入|收入)(?:的)?(?:综合)?能源(?:消耗|消费)(?:量|强度)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_SO2_INTENSITY",
        re.compile(
            r"(?:每百万|单位)(?:元)?(?:营收|营业收入|收入)(?:的)?(?:二氧化硫|SO2|SO₂)(?:排放)?(?:量|强度)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_SO2_INTENSITY",
        re.compile(
            r"(?:万元|百万元)(?:产值|营收|收入)(?:二氧化硫|SO2|SO₂)(?:排放)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_NOX_INTENSITY",
        re.compile(
            r"(?:每百万|单位)(?:元)?(?:营收|营业收入|收入)(?:的)?(?:氮氧化物|NOx|NOₓ)(?:排放)?(?:量|强度)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_NOX_INTENSITY",
        re.compile(
            r"(?:万元|百万元)(?:产值|营收|收入)(?:氮氧化物|NOx|NOₓ)(?:排放)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_WATER_INTENSITY",
        re.compile(
            r"(?:每百万|单位)(?:元)?(?:营收|营业收入|收入)(?:的)?(?:水资源|用水|耗水)(?:消耗)?(?:量|强度)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_WATER_INTENSITY",
        re.compile(
            r"(?:万元|百万元)(?:产值|营收|收入)(?:水资源|用水|耗水)(?:消耗)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_SOLID_WASTE_INTENSITY",
        re.compile(
            r"(?:每百万|单位)(?:元)?(?:营收|营业收入|收入)(?:的)?(?:一般)?(?:固体)?废物(?:产生)?(?:量|强度)?" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        ...
        re.compile(
            r"(?:安全生产|生产安全)(?:投入|费用|支出)(?:占比|比例|占营业收入比例)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        ...
        re.compile(
            r"(?:员工|职工|雇员)(?:平均)?(?:薪酬|工资|报酬|年薪|薪资)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_S_ENV_INVEST_RATE",
        re.compile(
            r"环(?:境)?(?:保护|保|境保护)(?:投入|支出|费用|投资|成本)(?:占比|比例)?\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]?\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_S_RD_RATE",
        re.compile(
            r"(?:研发|R&D|RD|研究开发)(?:费用|投入|支出|经费)(?:占比|比例)?\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]?\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_S_EMPLOYEE_TRAINING_HOUR",
        re.compile(
            r"(?:员工|职工|人均)(?:人均)?培训(?:时长|时间)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_S_SOCIAL_INSURANCE_RATE",
        re.compile(
            r"社会?保险(?:缴纳|覆盖|参保)?(?:率|比例)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]?\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_S_FEMALE_MANAGER_RATE",
        re.compile(
            r"女性(?:管理|高管|领导|管理人员)(?:人员|者|干部)?(?:占比|比例)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]?\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        ...
        re.compile(
            r"(?:再生|循环|中水|替代|回用)水(?:源)?(?:使用|利用|回用)?(?:占比|比例|率)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]?\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        ...
        re.compile(
            r"(?:清洁|可再生|绿色|新)能源(?:使用|消费|消耗|利用)?(?:占比|比例|强度)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]?\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_WATER_CONSUMPTION",
        re.compile(
            r"水资源?(?:消耗|用水|取水)(?:总)?量\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_E_ENERGY_CONSUMPTION",
        re.compile(
            r"(?:综合|总)?能源(?:消耗|消费)(?:总)?量\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        ...
        re.compile(
            r"(?:温室气体|碳|GHG|CO2)(?:减排|减少|降低)(?:率|比例|幅度)\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*[%％]?\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_G_AUDIT_COMMITTEE_MEETING_FREQ",
        re.compile(
            r"审计委员会(?:会议)?(?:召开)?次数\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
    ...
    DirectRule(
        "Q_E_GHG_EMISSION",
        re.compile(
            r"(?:温室气体|碳|GHG|CO2|二氧化碳)(?:排放)?(?:总)?量\s+" +
            r"(?:[^\n]*?)" +
            r"(?:[\d,]+(?:\.\d+)?\s+)*" +
            NUMBER + r"\s*$",
            re.I | re.MULTILINE
    ...
    DirectRule(
        "Q_S_SAFETY_INVEST_RATE",
        re.compile(
            # 单位在前的单值：比例 % 0.20；允许上年列用 — / 占位，但拒绝再跟第二个年份数值
            # 禁止把 1.66 回退成 1（负向预查勿逼小数部分退让）
            r"安全生产投入占营业收入(?:的)?比例\s*[%％]\s*(?:(?:—|--|/|-)\s*)*"
            + NUMBER
            + r"(?!\.?\d)(?!\s*(?:[\d,]+(?:\.\d+)?|—|--|/|-))",
        ),
        1.0,
...
ENGLISH_REVENUE_INTENSITY_RULES = (
    ...
    # 港股双语：Water consumption intensity 耗水密度 tonnes/RMB10,000\n噸╱萬元營收 0.94
    # 注意 extract 路径会先 _normalize 压空白，故用 \s+ 而非强制换行。
    EnglishRevenueIntensityRule(
        "Q_E_WATER_INTENSITY",
        re.compile(
            r"(?:Water\s+consumption\s+intensity|耗水密度|用水密度)"
            r".{0,60}?(?P<numerator>tonnes?|tons?|kg)/RMB\s*(?P<scale>10,?000)"
            r"\s+(?:噸\s*[／/╱]\s*萬元營收|吨\s*[／/╱]\s*万元营收)\s*"
            r"(?P<value>[\d,]+(?:\.\d+)?)\b",
            re.I | re.S,
        ),
        .93,
    ),
    # 港股双语：Non-hazardous waste emission 無害廢棄物排放密度 tonnes/RMB10,000 噸╱萬元營收 0.00031
    EnglishRevenueIntensityRule(
        "Q_E_SOLID_WASTE_INTENSITY",
        re.compile(
            r"(?:Non-hazardous\s+waste\s+emission(?:\s+density)?|無害廢棄物(?:排放)?密度)"
            r".{0,80}?(?P<numerator>tonnes?|tons?|kg)/RMB\s*(?P<scale>10,?000)"
            r"\s+(?:噸\s*[／/╱]\s*萬元營收|吨\s*[／/╱]\s*万元营收)\s*"
            r"(?P<value>[\d,]+(?:\.\d+)?)\b",
            re.I | re.S,
        ),
...
def extract_from_simple_tables(pages: list[PageText], company_code: str, company_name: str,
    ...
    indicator_keywords = {
        "Q_E_GHG_INTENSITY": ["温室气体", "碳排放", "GHG", "CO2排放", "CO₂排放", "二氧化碳排放", "碳强度", "温室气体强度", "碳密度", "每百万营收温室气体", "单位营收碳排放", "万元碳排放", "碳排放强度"],
        "Q_E_ENERGY_INTENSITY": ["能源消耗", "能源强度", "综合能耗", "单位能耗", "能耗强度", "能源使用", "能源密度", "每百万营收能耗", "单位营收能耗", "万元能耗", "综合能源消耗强度", "能源消费强度"],
        "Q_E_WATER_INTENSITY": ["水资源", "用水强度", "耗水强度", "单位水耗", "水耗强度", "新鲜水", "水资源强度", "水消耗强度", "每百万营收用水", "单位营收用水", "万元用水", "水资源使用强度"],
        "Q_E_NOX_INTENSITY": ["氮氧化物", "NOx", "NOₓ", "氮化物", "氮氧化合物", "氮氧化物强度", "NOx强度", "每百万营收氮氧化物", "单位营收NOx", "万元NOx", "氮氧化物排放强度"],
        "Q_E_SO2_INTENSITY": ["二氧化硫", "SO2", "SO₂", "二氧化硫强度", "SO2强度", "每百万营收二氧化硫", "单位营收SO2", "万元SO2", "二氧化硫排放强度"],
        "Q_E_PM_INTENSITY": ["颗粒物", "PM", "粉尘", "烟尘"],
        "Q_E_SOLID_WASTE_INTENSITY": ["固体废物", "固废", "一般固废", "固体废弃物", "一般废物", "工业固废", "固废强度", "一般固废强度", "每百万营收固废", "单位营收固废", "万元固废", "固体废物产生强度"],
        ...
        "Q_S_SAFETY_INVEST_RATE": ["安全投入", "安全生产", "安全费用", "安全生产投入", "安全投资", "生产安全"],
...
def _canonical_unit(unit: str) -> str:
    ...
    # 强度分母常见后缀：吨/万元营业收入 → 吨/万元，便于命中 unit_factors
    compact = re.sub(r"(?:人民币)?(?:营业收入|营收|收入|产值)$", "", compact)
    return compact
...
_CN_TABLE_RULES: tuple[tuple[str, str, tuple[tuple[str, float], ...]], ...] = (
    ...
    ("Q_E_WATER_INTENSITY", r"水资源(?:使用|消耗)强度|(?:单位营收)?(?:用水|耗水|取水)(?:强度|密度|量)", (
        ...
        ("吨/百万营收", 10.0),
        ("立方米/万元", 1000.0), ("立方米/万元营收", 1000.0),
        ("立方米/百万元", 10.0), ("立方米/百万营收", 10.0), ("千克/万元", 1.0),
    )),
    ("Q_E_SO2_INTENSITY", r"二氧化硫(?:\s*[（(]\s*SO[₂2]\s*[）)])?排放强度", (
        ("吨/万元", 1_000_000.0), ("吨/百万元", 10_000.0),
        ("吨/百万元营收", 10_000.0), ("吨/百万元营业收入", 10_000.0),
        ("千克/万元", 1000.0), ("千克/百万元", 10.0), ("克/万元", 1.0), ("克/百万元", 0.01),
    )),
    ("Q_E_NOX_INTENSITY", r"氮氧化物(?:\s*[（(]\s*NO[xXₓ]\s*[）)])?排放强度|每百万营收氮氧化物排放量", (
        ("千克/万元", 1000.0), ("千克/百万元", 10.0), ("克/万元", 1.0), ("克/百万元", 0.01),
    ...
    ("Q_E_SOLID_WASTE_INTENSITY", r"一般固体废物(?:排放|产生)?(?:强度|密度)|一般固废(?:排放|产生)?(?:强度|密度)|一般废弃物产生强度|单位营收(?:一般|无害)废弃物(?:产生|处置)?量", (
        ...
        ("吨/百万元营收", 10.0), ("吨/百万元营业收入", 10.0), ("吨/百万营收", 10.0),
        ("千克/万元", 1.0),
    )),
    ...
    ("Q_S_ENV_INVEST_RATE", r"环保(?:总)?投入占营业收入(?:的)?比例|环境保护总投入占营业收入(?:的)?比例|环保费用占营业收入比例", (("%", 1.0),)),
    ("Q_S_SAFETY_INVEST_RATE", r"安全生产投入占营业收入(?:的)?比例|安全投入占营业收入比例|安全费用占营业收入比例", (("%", 1.0),)),
    ("Q_S_RD_RATE", r"研发投入占营业收入(?:的)?比例|研发费用占营业收入比例|R&D投入比例", (("%", 1.0),)),
    ("Q_S_DONATION_RATE", r"(?:对外)?捐赠(?:总额)?占营业收入(?:的)?比例|公益捐赠占营业收入比例", (("%", 1.0),)),
    ("Q_S_PAY_PER_EMPLOYEE", r"(?:员工|职工)(?:平均)?薪酬|人均薪酬", (
        ("万元/人", 10000.0), ("万元", 10000.0), ("千元/人", 1000.0), ("元/人", 1.0),
    )),
    ("Q_S_FEMALE_EMPLOYEE_RATE", r"女性员工占比|女性职工比例", (("%", 1.0),)),
    ("Q_S_EMPLOYEE_TRAINING_HOUR", r"(?:员工|职工)(?:人均)?培训时长|人均培训时间", (
        ("小时", 1.0), ("课时", 1.0), ("学时", 1.0),
    )),
    ("Q_G_DEBT_ASSET_RATE", r"资产负债率", (("%", 1.0),)),
    ("Q_E_GHG_EMISSION", r"温室气体(?:排放)?(?:总)?量|碳排放(?:总)?量", (
        ("万吨", 10000.0), ("吨", 1.0), ("千吨", 1000.0),
    )),
    ("Q_E_SO2_EMISSION", r"二氧化硫(?:\s*[（(]\s*SO[₂2]\s*[）)])?\s*(?:排放)?(?:总)?量|SO2(?:排放)?(?:总)?量", (
        ("吨", 1.0), ("万吨", 10000.0), ("千吨", 1000.0), ("千克", 0.001),
    )),
    ("Q_E_NOX_EMISSION", r"氮氧化物(?:\s*[（(]\s*NO[xXₓ]\s*[）)])?\s*(?:排放)?(?:总)?量(?:\s*[（(]\s*NO[xXₓ]\s*[）)])?|废气中氮氧化物(?:\s*[（(]\s*NO[xXₓ]\s*[）)])?(?:排放)?(?:总)?量|NOx(?:排放)?(?:总)?量", (
        ("吨", 1.0), ("万吨", 10000.0), ("千吨", 1000.0), ("千克", 0.001),
    )),
    ("Q_E_PM_EMISSION", r"颗粒物(?:排放)?(?:总)?量|粉尘(?:排放)?(?:总)?量", (
        ("吨", 1.0), ("万吨", 10000.0), ("千吨", 1000.0), ("千克", 0.001),
    )),
    ("Q_E_WASTEWATER_DISCHARGE", r"废水(?:排放)?(?:总)?量|污水(?:排放)?(?:总)?量", (
        ("吨", 1.0), ("万吨", 10000.0), ("立方米", 1.0), ("万立方米", 10000.0),
    )),
    ("Q_E_SOLID_WASTE_GENERATION", r"一般固(?:体)?废物(?:产生)?(?:总)?量|一般固废(?:产生)?(?:总)?量", (
        ("吨", 1.0), ("万吨", 10000.0), ("千吨", 1000.0),
    )),
    ("Q_E_HAZ_WASTE_GENERATION", r"危险废物(?:产生)?(?:总)?量|危废(?:产生)?(?:总)?量", (
        ("吨", 1.0), ("万吨", 10000.0), ("千吨", 1000.0),
    )),
    ("Q_E_ENERGY_CONSUMPTION", r"(?:综合|总)?能源消耗(?:总)?量|能源使用(?:总)?量", (
        ("吨标准煤", 1.0), ("万吨标准煤", 10000.0), ("千吨标准煤", 1000.0),
    )),
    ("Q_E_WATER_CONSUMPTION", r"水资源消耗(?:总)?量|用水(?:总)?量|取水(?:总)?量", (
        ("吨", 1.0), ("万吨", 10000.0), ("立方米", 1.0), ("万立方米", 10000.0),
    )),
    ("Q_S_LABOR_CONTRACT_RATE", r"劳动合同签订率|劳动合同覆盖率", (("%", 1.0),)),
    ("Q_S_EMPLOYEE_TURNOVER_RATE", r"员工流失率|职工离职率", (("%", 1.0),)),
    ("Q_G_BOARD_SIZE", r"董事会成员|董事会人数|董事人数", (("人", 1.0),)),
    ("Q_G_BOARD_MEETING_FREQ", r"董事会会议次数|董事会召开次数", (("次", 1.0),)),
    ("Q_G_SUPERVISOR_MEETING_FREQ", r"监事会会议次数|监事会召开次数", (("次", 1.0),)),
    ("Q_G_SHAREHOLDER_MEETING_FREQ", r"股东大会次数|股东会议次数", (("次", 1.0),)),
    ("Q_G_AUDIT_COMMITTEE_MEETING_FREQ", r"审计委员会会议次数|审计委员会召开次数", (("次", 1.0),)),
)
...
def _chinese_year_table_mode(text: str, report_year: int) -> str | None:
    ...
    previous_year = report_year - 1
    # 港股/双语报告常见繁体表头；先归一到简体再匹配，避免漏检。
    text = (
        text.replace("指標", "指标").replace("單位", "单位").replace("項目", "项目")
        .replace("名稱", "名称").replace("數值", "数值").replace("數據", "数据")
    )
    if re.search(
    ...
    if re.search(rf"(?:关键绩效|环境绩效|责任绩效|环保绩效)\s*单\s*位\s*{report_year}\s*年?", text):
        return "single-year"
    # 301439 等：关键指标 基准单位 2025 年（勿误判为三年 current-last）
    if re.search(rf"(?:关键指标|关键绩效)\s*基准单位\s*{report_year}\s*年?", text):
        return "single-year"
    # 健康安全/按类别划分：单位 2024 年 2025 年
    if re.search(
        rf"(?:按类别划分|健康安全指标|关键绩效|环境绩效)\s*单\s*位\s*{previous_year}\s*年?\s*{report_year}\s*年?",
        text,
    ):
        return "current-last"
    if re.search(
        rf"(?:按类别划分|健康安全指标)\s*单\s*位\s*{report_year}\s*年?",
        text,
    ):
        return "single-year"
    ...
    for code, label, units in _CN_TABLE_RULES:
        ...
        if code in {
            ...
            if code in {"Q_S_SAFETY_INVEST_RATE", "Q_S_RD_RATE"}:
                ...
                patterns.append((
                    "vertical-percent-unit-then-values",
                    rf"(?m)^\s*{label_group}\s*\n\s*(?P<unit>[%％])\s*\n\s*"
                    rf"(?:(?:{_CN_NUMBER}|—|--|/|-)\s*\n\s*){{0,2}}(?P<current>{_CN_NUMBER})\s*$",
                ))
                # 同行：比例 % 0.20；或 % — — 0.15（上年占位）
                patterns.append((
                    "inline-percent-unit-first",
                    rf"(?m)^\s*{label_group}\s*(?P<unit>[%％])\s*(?:(?:—|--|/|-)\s*)*(?P<current>{_CN_NUMBER})"
                    rf"(?!\s*(?:{_CN_NUMBER}|—|--|/|-))\s*$",
                ))
                patterns.append((
                    "inline-percent-midline",
                    rf"{label_group}\s*(?P<unit>[%％])\s*(?:(?:—|--|/|-)\s*)*(?P<current>{_CN_NUMBER})"
                    rf"(?!\s*(?:{_CN_NUMBER}|—|--|/|-))\s*$",
                ))
                # 三年/两年：取末列本期（current-last）
                patterns.append((
                    "inline-percent-current-last",
                    rf"(?m)^\s*{label_group}\s*(?P<unit>[%％])\s*"
                    rf"(?:(?:{_CN_NUMBER}|—|--|/|-)\s+){{1,2}}(?P<current>{_CN_NUMBER})\s*$",
                ))
                patterns.append((
                    "inline-percent-midline-current-last",
                    rf"{label_group}\s*(?P<unit>[%％])\s*"
                    rf"(?:(?:{_CN_NUMBER}|—|--|/|-)\s+){{1,2}}(?P<current>{_CN_NUMBER})\s*$",
                ))
            ...
            # 无表头时的竖排两年强度：页内同时有上年/本年标签时取末列（601567.SH）
            if code in {
                "Q_E_GHG_INTENSITY", "Q_E_ENERGY_INTENSITY", "Q_E_NOX_INTENSITY",
                "Q_E_SO2_INTENSITY", "Q_E_WATER_INTENSITY", "Q_E_SOLID_WASTE_INTENSITY",
                "Q_E_HAZ_WASTE_INTENSITY",
            } and mode is None and re.search(rf"{report_year - 1}\s*年", text) and re.search(rf"{report_year}\s*年", text):
                patterns.append((
                    "vertical-two-year-intensity",
                    rf"(?m)^\s*{label_group}\s*(?:\n\s*[（(][^）\n]{{0,40}}[）)])?\s*\n\s*"
                    rf"(?P<unit>{unit_pattern})\s*\n\s*"
                    rf"{_CN_NUMBER}\s*\n\s*(?P<current>{_CN_NUMBER})\s*$",
                ))
                patterns.append((
                    "inline-two-year-intensity",
                    rf"(?m)^\s*{label_group}\s*(?P<unit>{unit_pattern})\s*"
...
def _plausible_value(code: str, value: float) -> bool:
    ...
    if code == "Q_S_DIVIDEND_PER_SHARE" and value > 100:
        return False
    # 营业收入必须以人民币元计；拦截把年份/脚注小数误当成营收的宽匹配
    if code == "Q_G_REVENUE" and value < 1_000_000:
        return False
    return True
...
def _is_direct_false_positive(code: str, text: str, match: re.Match[str]) -> bool:
    ...
    if code == "Q_G_ROE":
        ...
        if any(token in matched for token in ("同比", "增加", "减少", "提升", "下降", "上升", "增长", "变动", "较上年", "不适用")):
            return True
        return False
    if code == "Q_S_SAFETY_INVEST_RATE":
        # 拒绝保障率/完备率/完成率及页码噪声；只保留明确占营收比例语义
        if re.search(r"保障率|完备率|完成率|整改率|覆盖率|合规率|认证", window):
            return True
        english_ok = bool(re.search(
            r"Proportion\s+of\s+.*safety.*(?:revenue|investment)|"
            r"Work\s+safety\s+investment\s+as\s*%|"
            r"safety\s+investment.*(?:revenue|%)",
            matched, re.I,
        ))
        chinese_ok = bool(re.search(r"占营业收入|占营收|占比|比例", matched))
        if not (english_ok or chinese_ok):
            return True
        try:
            value = float(match.group(1).replace(",", ""))
        ...
        if value is not None and (value <= 0 or value > 30):
            return True
        return False
    if code in {"Q_E_SO2_INTENSITY", "Q_E_SO2_EMISSION"}:
        # 硫氧化物/SOx/硫化物 不得映射为二氧化硫
        if re.search(r"硫氧化物|硫化物|SOx", window) and not re.search(r"二氧化硫|SO2|SO₂", matched):
            return True
        if re.search(r"减排|削减|去除|相当于|协助减少", window):
            return True
        # _normalize 后换行消失，$ 易吞页尾/下一指标；交给年表或带单位 RULES
        if code == "Q_E_SO2_EMISSION" and (
            re.search(r"intensity|密度|强度", window + matched, re.I)
            or len(matched) > 90
            or re.search(r"一般工业固废|召开|废渣|污染物排放总量|ENVIRONMENTAL|培训次数", matched)
        ):
            return True
        return False
    if code in {"Q_E_NOX_INTENSITY", "Q_E_NOX_EMISSION"}:
        if re.search(r"减排|削减|去除|相当于|协助减少", window):
            return True
        if code == "Q_E_NOX_EMISSION" and (
            re.search(r"intensity|密度|强度", window + matched, re.I)
            or len(matched) > 90
            or re.search(r"召开|废渣|污染物排放总量|综合利用率|ENVIRONMENTAL|培训次数", matched)
        ):
            return True
        if code == "Q_E_NOX_INTENSITY" and (
            len(matched) > 100
            or re.search(r"专利|实用新型|发明|申请数量|授权数量", matched)
            or (
                re.search(r"千克\s*[／/]\s*万元|吨\s*[／/]\s*百万元", matched)
                and len(re.findall(r"\d+\.\d+", matched)) >= 2
                and "Chinese" not in matched
            )
        ):
            return True
        return False
    if code == "Q_E_WATER_INTENSITY":
        # 拒绝把页码/脚注整数当成用水强度；同年表已有“吨/百万营收”时交给年表解析
        try:
            value = float(match.group(1).replace(",", ""))
        except (IndexError, ValueError):
            value = None
        matched = match.group(0)
        # _normalize 后换行消失，$ 落到页尾，易吞“03/04”页码
        if value is not None and value == int(value) and 1 <= value <= 200:
            if re.search(r"用水强度\s*吨\s*[／/╱]\s*百万营收", window):
                return True
            if len(matched) > 120 or re.search(
                r"(?:年度(?:环境|社会)|ENVIRONMENTAL,\s*SOCIAL|走进|公司概况|报告\s*$)",
                matched,
                re.I,
            ):
                return True
            if re.search(
                rf"水资源?(?:使用|消耗)强度\s*{re.escape(match.group(1).replace(',', ''))}"
                rf"(?!\s*(?:吨|立方米|千克|kg|m³)\s*[／/])",
                matched,
            ) and re.search(r"(?:吨|立方米)\s*[／/]\s*万?元", matched):
                # 标签旁已有带单位真值，却把远处整数当强度
                return True
        return False
    return False
